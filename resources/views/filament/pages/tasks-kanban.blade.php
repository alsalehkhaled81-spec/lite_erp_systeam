        ...
        <div class="flex gap-5 overflow-x-auto pb-6 scroll-smooth" style="scrollbar-width: thin;">
            @foreach($statuses as $status)
                ...
                <div class="flex-shrink-0 w-80 rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-lg"
                    ...
                    <div class="space-y-3 p-4 min-h-[120px] kanban-column transition-colors duration-200"
                        ...
                        @foreach($status['records'] as $task)
                            ...
                            <div class="group rounded-xl p-4 transition-all duration-200 cursor-grab hover:-translate-y-0.5 hover:shadow-md
                                        ...
                                        backdrop-blur-sm kanban-card active:cursor-grabbing active:shadow-lg"
        ...
        return {
            ...
            handleDragEnd(event) {
                ...
                document.querySelectorAll('.kanban-column').forEach(col => {
                    col.classList.remove('ring-2', 'ring-blue-400', 'ring-opacity-50');
                });
            },
            setupDragAndDrop() {
                document.querySelectorAll('.kanban-column').forEach(column => {
                    column.addEventListener('dragover', (e) => {
                        ...
                        column.classList.add('ring-2', 'ring-blue-400', 'ring-opacity-50');
                    });

                    column.addEventListener('dragleave', (e) => {
                        if (!column.contains(e.relatedTarget)) {
                            column.classList.remove('ring-2', 'ring-blue-400', 'ring-opacity-50');
                        }
                    });
                    ...
                    column.addEventListener('drop', (e) => {
                        ...
                        if (this.draggedTaskId && newStatus) {
                            $wire.updateTaskStatus(this.draggedTaskId, newStatus).then(() => {
